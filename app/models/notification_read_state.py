...
class NotificationReadState(Base):
    ...
    # Set the moment THIS user deletes the broadcast row - the row
    # itself is never removed (other users still see it), this just
    # hides it from this user's Inbox and Bin permanently.
